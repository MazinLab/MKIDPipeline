    ...
    def _metadata(self):
        ...
        try:
            d.update(dict(E_CXREFX=self.wcscal.conex_ref[0], E_CXREFY=self.wcscal.conex_ref[1],
                          ...
                          E_PLTSCL = self.wcscal.platescale.value if self.wcscal.platescale is not None and self.wcscal.platescale.value else self.photontable.query_header('E_PLTSCL'),
