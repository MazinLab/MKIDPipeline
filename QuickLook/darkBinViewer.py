...
Modified from darkQuickViewer.py to work with .bin files, rather than .img
'''
...
class DarkQuick(QtGui.QMainWindow):
    def __init__(self, startTstamp, endTstamp):
        ...
        self.setWindowTitle('Darkness Binary File Viewer')
        self.createWidgets()
        self.initWindows()
        self.createMenu()
    ...
    def aboutMessage(self):
        msg = """ Use to open and view DARKNESS .bin files
        """
