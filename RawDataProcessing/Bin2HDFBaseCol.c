...
int main(int argc, char *argv[])
{
    ...
    size_t dst_offset[NFIELD] = { HOFFSET( photon, resID), HOFFSET( photon, timestamp ), HOFFSET( photon, wvl ), HOFFSET(photon, baseline), HOFFSET( photon, wSpec ), HOFFSET( photon, wNoise) };
    size_t dst_sizes[NFIELD] = { sizeof(p1.resID), sizeof(p1.timestamp), sizeof(p1.wvl), sizeof(p1.baseline), sizeof(p1.wSpec), sizeof(p1.wNoise) };
    ...
    { "ResID","Time","Wavelength","Baseline","SpecWeight","NoiseWeight"};
